	...
	<div class="container">		
    	...
    	<div class="row-fluid">
	    	<div class="span12">
				...
				<?php 
					if(isset($_GET['msjpregunta'])){
						switch ($_GET['msjpregunta']) {
							case 1: alertas("La operación se llevo correctamente.",1); break;
							case 2: alertas("Hubo un error al guardar los datos. Intente de nuevo",2); break;
						}		
					}

					if(isset($_GET['msjdelete'])){
						switch ($_GET['msjdelete']) {
							case 1: alertas("La operación se llevo correctamente.",1); break;
							case 2: alertas("Hubo un error al eliminar la pregunta. Intente de nuevo",2); break;
						}		
					}
				?>
			</div>
